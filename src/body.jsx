    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-grow flex flex-wrap justify-center items-center gap-6 p-2">
        ...
        <Card
          ...
          image={
            "https://img.freepik.com/free-photo/workplace-business-modern-male-accessories-laptop-white_155003-1722.jpg?size=626&ext=jpg&ga=GA1.1.44546679.1716336000&semt=ais_user"
          }
        />
        <Card
          title={"Kitchen"}
          ...
          image={
            "https://c1.wallpaperflare.com/preview/370/450/397/spoon-fork-knife-kitchen.jpg"
          }
        />
        <Card
          title={"Sport Kits"}
          image={
            "https://i.pinimg.com/originals/c4/c6/09/c4c60940da2d250e5472fe2fbf85f3e7.jpg"
          }
